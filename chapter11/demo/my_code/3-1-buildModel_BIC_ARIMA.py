...
'''
              0            1            2            3            4
0  1166.398597  1169.307301  1170.991139  1168.426909  1172.077481
1  1169.644775  1167.330816  1170.685519  1171.723426  1175.140562
2  1172.246538  1170.590838          NaN  1174.739524  1180.268845
3  1170.473345  1173.422439  1177.114533  1180.531660          NaN
4  1173.366376  1177.079054  1178.163939  1182.219600          NaN
...
while 1:
    ...
    if h > 0:
        ...
        # print(p,q)
        print('模型ARIMA(%s,1,%s)符合白噪声检验' % (p,q))
        break

'''
pred_error的p值为: [0.47455226 0.45421413 0.10528567 0.05642716 0.09648414 0.15565755
 0.05479088 0.08700279 0.12206878 0.16186804 0.20217712 0.13953557]
h= 0
...
result_d.to_excel('../my_data/pedictdata_C_BIC_ARMA.xlsx')

# 第   5   步--D盘---------模型评价
# 为了评价时序预测模型效果的好坏，本章采用3个衡量模型预测精度的统计量指标：平均绝对误差、均方根误差、平均绝对百分误差
result = pd.read_excel('../my_data/pedictdata_C_BIC_ARMA.xlsx', index_col='COLLECTTIME')
